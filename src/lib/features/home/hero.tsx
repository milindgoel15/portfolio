	...
	return (
		<>
			<section className="px-4 md:px-8 xl:px-32 2xl:px-52 py-8 gap-5 flex flex-col justify-center text-center items-center dark:text-white">
				...
				>
					Hi! I&apos;m Milind Goel, a Software Engineer, based in India. My primary focus is on
					crafting seamless and visually engaging user experiences. If you&apos;re seeking
					someone who can bring your digital ideas to life, count me in! I&apos;m here and
